...
!(function () {
  ...
  let b,
    ...
    te = null,
    ne = null;
  const oe = (e) => "" != `${e}` && void 0 !== e;
  const ie = (...e) => [`[iframe-resizer][${H}]`, ...e].join(" "),
    re = (...e) => console?.warn(ie(...e)),
    ae = (...e) =>
      console?.warn(
        (
          (e) => (t) =>
  ...
  function ce() {
    !(function () {
      try {
        U = "iframeParentListener" in window.parent;
      } catch (e) {}
    })(),
      (function () {
        const e = (e) => "true" === e,
        ...
        (H = t[0]),
          ...
          (S = t[9]),
          (O = t[10]),
          (Z = void 0 === t[11] ? Z : Number(t[11])),
          (R.enable = void 0 !== t[12] && e(t[12])),
          (W = void 0 === t[13] ? W : t[13]),
          (G = void 0 === t[14] ? G : t[14]),
          (D = void 0 === t[15] ? D : e(t[15])),
          (b = void 0 === t[16] ? b : Number(t[16])),
          (w = void 0 === t[17] ? w : Number(t[17])),
          (M = void 0 === t[18] ? M : e(t[18])),
          t[19],
          (X = t[20] || X),
          (q = void 0 === t[21] ? q : Number(t[21]));
      })(),
      (function () {
        function e() {
  ...
  function de(e) {
    ue({ method: e, eventType: "After Print", eventName: "afterprint" }),
      ue({ method: e, eventType: "Before Print", eventName: "beforeprint" }),
      ue({
        method: e,
  ...
  function je(e) {
    ...
    C.forEach((t) => {
      ...
      (c = performance.now() - c);
    const s = `\nParsed ${r} element${(r = "")} in ${c.toPrecision(
      3
    )}ms\n${t} ${
      T ? "tagged " : ""
    }element found at: ${a}px\nPosition calculated from HTML element: ${(function (
      e
    ) {
      const t = e?.outerHTML?.toString();
      return t
        ? t.length < 30
          ? t
          : `${t.slice(0, 30).replaceAll("\n", " ")}...`
        : e;
    })(o)}`;
    return (
      c < 1.1 ||
  ...
  function Te(e, t) {
    ...
    switch (!0) {
      case !e.enabled():
        return c;
      case !t && 0 === Pe[i] && 0 === Ce[i]:
        if (e.taggedElement(!0) <= a) return n();
        break;
      case Q && r === Pe[i] && c === Ce[i]:
        return Math.max(r, c);
      case 0 === r:
        return c;
      case !t && r !== Pe[i] && c <= Ce[i]:
        return n();
      case !o:
        return t
          ? e.taggedElement()
