...
!(function () {
  ...
  const t = (t) =>
    ...
    u = (e, t, i) => e.removeEventListener(t, i, !1),
    d = (e) => {
      if (!e) return "";
      let t = -559038744,
        i = 1103547984;
    ...
    m = ["NWSc3", "ihzpj", "wyvmlzzpvuhs", "ibzpulzz", "vlt"],
  ...
  function z(e) {
    ...
    const f = (e, t) => (i, n) => {
      ...
      p = (e, t) => () => {
        ...
        function o() {
          n(0, u), a.disconnect(), s.disconnect();
        }
        const r = P,
      ...
      ? a === `${H}`.slice(0, s) &&
        ...
        P
          ? ((function (e) {
              if (!w[e])
                throw new Error(
                  `${L.type} No settings for ${e}. Message was: ${H}`
                );
            })(P),
            L.type in { true: 1, false: 1, undefined: 1 } ||
              ...
              (function () {
                ...
                return (
                  null === L.iframe &&
                    (n(P, `The iframe (${L.id}) was not found.`), (e = !1)),
                  e
                );
              })() &&
                (function () {
                ...
                (function () {
                  switch (
                    (w[P]?.firstRun && w[P] && (w[P].firstRun = !1), L.type)
                  ) {
                    case "close":
                      k(L.iframe);
                      break;
                    ...
                    default:
                      if (0 === L.width && 0 === L.height)
                        return void n(
                          `Unsupported message received (${L.type}), this is likely due to the iframe containing a later version of iframe-resizer than the parent page`
                        );
      ...
      s in w && "iFrameResizer" in t
        ...
        : ((function (e) {
            ...
            (w[s] = {
              ...
              (function () {
                if ("horizontal" === w[s].direction)
                  return (w[s].sizeWidth = !0), void (w[s].sizeHeight = !1);
                if ("none" === w[s].direction)
                  return (
                    (w[s].sizeWidth = !1),
                    (w[s].sizeHeight = !1),
                    void (w[s].autoResize = !1)
                  );
                if ("vertical" !== w[s].direction)
                  throw new TypeError(
                    s,
                    `Direction value of "${w[s].direction}" is not valid`
                  );
              })(),
              (i = e?.offset),
              i &&
                ("vertical" === w[s].direction
                  ? (w[s].offsetHeight = i)
                  : (w[s].offsetWidth = i)),
              null === w[s].postMessageTarget &&
                (w[s].postMessageTarget = t.contentWindow),
              (w[s].targetOrigin =
                !0 === w[s].checkOrigin
                  ? "" === (n = w[s].remoteHost) ||
          ...
          (function () {
            switch (
              ((t.style.overflow = !1 === w[s]?.scrolling ? "hidden" : "auto"),
              w[s]?.scrolling)
            ) {
              case "omit":
                break;
          ...
          (function () {
            if (w[s]) {
              const e = {
                close: k.bind(null, w[s].iframe),
                disconnect: $.bind(null, w[s].iframe),
                removeListeners() {
                  o(
                    s,
    ...
    function e(e) {
      switch (!0) {
        ...
        case "IFRAME" !== e.tagName.toUpperCase():
          throw new TypeError(
            `${H}Expected <IFRAME> tag, found <${e.tagName}>`
          );
        default:
          t(e), i.push(e);
      }
