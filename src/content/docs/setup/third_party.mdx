...
third parties that wish to include you iframe on their own sites. This approach allows you to update
how iframe-resizer is configured, without having to go back to your clients and ask them to make changes
to their sites.

### License

Set the license key in your pages displayed in the iframe. This will need to be included alongside the [child page](/setup/child) javascript file.
