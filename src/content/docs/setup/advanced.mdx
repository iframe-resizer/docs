...
the calculated page size. It can be provide with a positive or negative value.
...
the element and its descendants from the <span class="fig">Set</span> of overflown 
