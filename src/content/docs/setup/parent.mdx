...
<script type="module">
  import iframeResize from '/node_modules/@iframe-resizer/parent/index.umd.js'
...
<script type="module">
    ...
    import iframeResize from 'https://cdn.jsdelivr.net/npm/@iframe-resizer/parent@${VERSION}'
