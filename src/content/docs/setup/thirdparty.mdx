...
This page guides you through how to setup this up in a way that allows you to control how _iframe-resizer_ runs
after it has been included on another parties website.

#### Create Script
The recommended approach is to host a JS file on your site, based on the following example javascript. 
This code will create your iframe and then configure _iframe-resizer_.
