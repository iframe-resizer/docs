...
This guide explains how to create an Angular Directive for _iframe-resizer_ using the [Framework API](/api/frameworks).
...
Create the following directive, which expose the full _iframe-resizer_ feature set.

<Code lang="ts" title="iframe-resizer-directive.js" code={directive} />
