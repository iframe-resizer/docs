...
When removing an iframe you MUST first call _iframe-resizer's_ [disconnect()](../api/parent/#disconnect) method. This prevents issues if the iframe is then later re-added to the page.
