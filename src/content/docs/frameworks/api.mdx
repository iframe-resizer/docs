...
The returned `resizer` object contains the [Parent Page API methods](/api/parent#methods). This provides methods to disconnect _iframe-resizer_ from the iframe, to enable it to be safely removed from the page.
