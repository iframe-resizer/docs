...
the content. This inversion of the layout sizing paradigm can occasionally create some unexpected
results, as the content and the page both compete to adjust their size to meet the other.
