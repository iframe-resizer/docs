...
The most common  is having **absolutely positioned elements anchored to the bottom of the page**,  or using 
**Viewport / Percentage Sizing Units on the same axes that _iframe-resizer_ 
is controlling**. The [Iframe Content Guidelines](/content_guidelines) section explains both of these issues
