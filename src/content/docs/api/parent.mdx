...
The following example shows how to adjust the scroll point. This can be useful if you have a sticky header on your page and you need prevent the target scroll point ending up under your header.
```js
