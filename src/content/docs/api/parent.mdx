...
<Aside type="tip" title="Horizontal Resizing">
  ...
  working out the content width. If you can have to have elements on the right
  of the page, then you will need to tell _iframe-resizer_ which page element to
  use to calculated the width by adding a `data-frame-size` attribute.
</Aside>
