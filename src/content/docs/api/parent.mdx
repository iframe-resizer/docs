...
```
default: false
type:    boolean | 'collapsed' | 'expanded'
```

Enable logging to the console.

> _The console output uses [auto-console-log](https://www.npmjs.com/package/auto-console-group) to 
> automatically group messages by event._
