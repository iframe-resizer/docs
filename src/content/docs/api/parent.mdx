...
Passes a [`IFrameMessageData`](/api/types#iframemessagedata) object containing the **iframe** and
the **message**.
...
Function called after the mouse enters the iframe. Passes a [`IFrameMouseData`](/api/types#iframemousedata) object containing the **iframe**,
...
Function called after the mouse leaves the iframe. Passes a [`IFrameMouseData`](/api/types#iframemousedata) object containing the **iframe**,
**screenX**, **screenY** and the **type** of event that triggered the callback.
...
Function called after iframe resized. Passes a [`IFrameResizedData`](/api/types#iframeresizeddata) object containing the **iframe**, **height**, 
...
[parentIframe.scrollToOffset()](/api/child#scrolltooffsetx-y). Passes a
