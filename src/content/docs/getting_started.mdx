...
<Aside type="tip" title="Open source licence" icon="seti:license">
  For open source projects, _iframe-resizer_ is free to use under the Gnu Public License. To confirm that you are using it on a non-commercial project set the license option to __GPL-V3__
