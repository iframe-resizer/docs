...
<Aside title="Commercial use">
  To use _iframe-resizer_ in a commercial website or application, you need to
  purchase a one time license key. See the __[pricing](../purchase)__ page for
  details.
</Aside>

<Aside type="tip" title="Non-commercial use">
  For non-commercial use, _iframe-resizer_ is free to use under the Gnu Public License. To confirm that you are using it on a non-commercial project set the license option to __GPL-V3__
...
This package just needs to be included on every page that you load into the iframe. It will queitly listern for a message from the parent page, before initialising itself.
