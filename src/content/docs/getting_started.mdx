...
<Aside title="Commercial use">
  To use <i>iframe-resizer</i> in a commercial website or application, you need
  to purchase a one time license. See the pricing page for details.
</Aside>

<Aside type="tip" title="Non-commercial use">
  For non-commercial use, <i>iframe-resizer</i> is free to use under the Gnu Public License. To confirm that you are using it on a non-commercial project set the license option to <b>GPL-V3</b>
