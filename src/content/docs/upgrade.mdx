...
The `onInit()` method in the [Parent Page API](/api/parent) has been deprecated in favour of `onReady()`. This brings the parent page and child page names for this event inline with each other. 
