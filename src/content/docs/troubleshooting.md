...
The most common cause of this is not placing the [@iframe-resizer/child](https://iframe-resizer.com/getting_started/#child-page-setup) package inside the iFramed page.
...
It is not possible to add the required JavaScript to PDF and ODF files. However, you can get around this limitation by using [ViewerJS](http://viewerjs.org/) to render these files inside a HTML page, that also contains the iFrame [@iframe-resizer/child](https://iframe-resizer.com/getting_started/#child-page-setup) package.
