...
This file contains a three files, for the parent page you can choose between the vanilla JS (<b>iframe-resizer.parent.js</b>) 
version and a jQuery (<b>iframe-resizer.jquery.js</b>) version. Finally the third file (<b>iframe-resizer.child.js</b>)
